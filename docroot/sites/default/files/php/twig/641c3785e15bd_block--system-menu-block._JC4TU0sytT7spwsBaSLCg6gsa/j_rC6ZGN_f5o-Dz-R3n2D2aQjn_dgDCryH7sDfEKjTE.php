...
class __TwigTemplate_130d8ba173a9b53ae70fdb2f6807090d265d78caa172eab6d028f77c934957f2 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<section";
  ...
  ";
        ...
        if (($context["label"] ?? null)) {
            // line 56
            echo "    <h2";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["title_attributes"] ?? null), "addClass", [0 => ($context["title_classes"] ?? null)], "method", false, false, true, 56), 56, $this->source), "html", null, true);
            echo ">";
...
";
  ...
  ";
    ...
    {
        return new Source("", "themes/contrib/dxpr_theme/templates/block--system-menu-block.html.twig", "/private/var/www/test.drupal9.com/docroot/themes/contrib/dxpr_theme/templates/block--system-menu-block.html.twig");
    }
