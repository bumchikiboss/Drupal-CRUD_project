...
class __TwigTemplate_ff2e7dfeea3448a8b30acc943404771bb4dd2f2f8c1456afd37aa5df4952075a extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["menu_level"] ?? null) == 1) && twig_get_attribute($this->env, $this->source, $context["item"], "is_expanded", [], "any", false, false, true, 47))) {
  ...
  ";
    ...
    {
        return new Source("", "themes/contrib/dxpr_theme/templates/menu--main.html.twig", "/private/var/www/test.drupal9.com/docroot/themes/contrib/dxpr_theme/templates/menu--main.html.twig");
    }
