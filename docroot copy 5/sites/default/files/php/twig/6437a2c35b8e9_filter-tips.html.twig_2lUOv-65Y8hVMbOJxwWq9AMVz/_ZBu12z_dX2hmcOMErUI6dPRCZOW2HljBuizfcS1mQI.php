...
class __TwigTemplate_d6f73ce8bb752aac4ae562dafec9d8fa66da6ecd28260d6cacc8b7e59269f1ae extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["long"] ?? null)) ? (("filter-tips__item--id-" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["item"], "id", [], "any", false, false, true, 50), 50, $this->source)))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "core/themes/claro/templates/filter/filter-tips.html.twig", "/private/var/www/test.drupal9.com/docroot/core/themes/claro/templates/filter/filter-tips.html.twig");
    }
